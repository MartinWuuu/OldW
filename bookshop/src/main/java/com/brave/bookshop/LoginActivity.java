...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bmob.initialize(this, "f7b13680390433d04ce363fa05a63d31");
    ...
    private void check() {
        ...
        query.addWhereEqualTo("u_password",mPasswordView.getText().toString());
    ...
    private void saveUserInfo(user u){
        UserData.setUserData(LoginActivity.this,u.getU_email(),u.getU_name(),u.getU_contact());
    }
