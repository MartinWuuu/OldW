...
//        OkHttpUtils
//                .post()
//                .url("http://airsep.routeyo.net/airsep/lutsoft/sso/CheckSeCode.action")
//                .addParams("loginName", email)
//                .addParams("seCode", verification)
//                .build()
//                .execute(new StringCallback() {
...
//                        try {
//                            JSONObject jo = new JSONObject(response);
//                            Toast.makeText(RegisterActivity.this, jo.getString("errorMsg")+":"+email+":"+verification, Toast.LENGTH_LONG).show();
//                        } catch (JSONException e) {
//                            e.printStackTrace();
//                        }
//
